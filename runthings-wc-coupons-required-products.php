...
namespace Runthings_WC_Coupons_Required_Products;
...
class CouponsRequiredProducts
{
    ...
    public function validate_coupon_based_on_required_products(bool $is_valid, WC_Coupon $coupon, WC_Discounts $discount): bool
    {
        ...
        // Not required until a breaking change is made
        // BUG: Should not compare to the plugin version, but the version of the data structure
